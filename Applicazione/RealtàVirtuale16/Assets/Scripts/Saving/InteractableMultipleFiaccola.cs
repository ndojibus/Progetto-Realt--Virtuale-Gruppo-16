...
public class InteractableMultipleFiaccola : InteractableObject_Abstract
{
    [SerializeField]
    CameraTransitor m_doorTransitor;

    [SerializeField]
    InteractableMultipleFiaccola m_otherFiaccola;
    ...
    protected override void TransitionOutActions()
    {
        ...
        if(m_equiped && m_otherFiaccola.equiped && m_doorTransitor.forward != true)
