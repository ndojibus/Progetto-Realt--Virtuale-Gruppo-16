...
public class InteractableBag : InteractableObject_Abstract
{
    ...
    void Start () {
        ...
        m_item = this.transform.Find("sack").gameObject;
        if (m_item == null)
            Debug.LogError("Select an item!");

        m_equiped = true;

        createData(1);  //index 0, 1 significa che il sacco è ancora lì
    }
    ...
    private void TakeRuby()
    {
        ...
        saveData(0, 0);   // salva che il sacco è stato preso
    }
