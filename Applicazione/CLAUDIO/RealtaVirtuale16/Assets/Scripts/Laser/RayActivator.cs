...
public class RayActivator : TriggerActionBase
{
    ...
    Animator m_animatorComponent;   //animatore della porta
    ...
    public void Awake() {
        ...
        if (m_doorObject != null) {          
            m_animatorComponent = m_doorObject.GetComponent<Animator>();
    ...
    public override void Activate()
    {
        if (!m_activated)                                       //se l'interruttore non è attivo
        {
            ...
            m_animatorComponent.Play("DoorOpening");            //attiva l'animazione che apre la porta
        }
